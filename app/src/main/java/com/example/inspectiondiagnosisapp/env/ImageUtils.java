...
public class ImageUtils {
  ...
  private static Bitmap newrgbFrameBitmap = null;
  ...
  public static File saveBitmap(Context context, final Bitmap bitmap, final RectF location, final String filename, String faceortongue) {
    ...
    try {
      ...
      Bitmap newbitmap = Bitmap.createBitmap(bitmap, (int)location.left, (int)location.top, (int)(location.right-location.left),
              (int)(location.bottom-location.top), null, false);
//      Bitmap newbitmap = Bitmap.createBitmap(bitmap);
      newrgbFrameBitmap = adjustPhotoRotation(newbitmap, 90);
      newrgbFrameBitmap.compress(Bitmap.CompressFormat.JPEG, 100, out);//通过io流的方式来压缩保存图片
