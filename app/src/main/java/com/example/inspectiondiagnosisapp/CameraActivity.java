...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tongue_detection);
        ...
        if (hasPermission()) {
            ...
            // 相机权限请求requestPermission，通过发送android.permission.CAMERA 权限请求即可
            LOGGER.i("not hasPermission");
            requestPermission();
        }
    ...
    public static void turnLightOn(Camera camera){
        LOGGER.i("step in turnLightOn function...");
        if (camera == null) {
            return;
        }
...
//          }
        ...
        LOGGER.i("step out turnLightOn function...");
    }
    ...
    public void onPreviewFrame(final byte[] bytes, final Camera camera) {
        ...
        LOGGER.i("step in onPreviewFrame function...");
        try {
...
//        camera.setDisplayOrientation(180);
        ...
        processImage(); // 这儿是关键，利用训练模型来预测图片
        LOGGER.i("step out onPreviewFrame function...");
    }
    ...
    public void onImageAvailable(final ImageReader reader) {
        ...
        // 当相机预览图片准备好时，Android系统的cameraDevice会回调之前注册的
        // OnImageAvailableListener。onImageAvailable函数就是
        // OnImageAvailableListener所做的事情
    ...
    private String chooseCamera() {
        // 利用CameraManager这个Android底层类，打开摄像头
    ...
    protected void setFragment() {
        ...
        LOGGER.i("Camera id is:", cameraId);
        ...
        if (useCamera2API) {
            ...
            CameraConnectionFragment camera2Fragment =
                    CameraConnectionFragment.newInstance(
                            ...
                            this,
                            getLayoutId(), // 调用DetectorActivity中的getLayoutId函数，返回camera_connection_fragment_tracking布局
