...
public abstract class CameraFaceActivity extends AppCompatActivity
...
//        }
 ...
 protected void setFragment() {
        ...
        if (useCamera2API) {
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                  ...
                                  CameraFaceActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
          ...
          LegacyCameraConnectionFragmentFace frag = new LegacyCameraConnectionFragmentFace(this,
                    getLayoutId(),
