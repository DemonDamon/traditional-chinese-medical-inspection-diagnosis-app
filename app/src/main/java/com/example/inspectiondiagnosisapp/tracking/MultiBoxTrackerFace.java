...
package com.example.inspectiondiagnosisapp.tracking;
...
import com.example.inspectiondiagnosisapp.tflite.SimilarityClassifier.Recognition;
...
public class MultiBoxTrackerFace {
  ...
  public MultiBoxTrackerFace(final Context context) {
